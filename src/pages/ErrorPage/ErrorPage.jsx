...
const ErrorPage = () => {
    ...
    return (
        <div className='mx-2'>
            ...
            <h1 className="text-4xl px-2 lg:text-8xl">{status}</h1>
            <h1 className="text-xl text-center px-2 font-semibold lg:text-2xl">Oops! {status} Page || Content you are trying to fetch is {statusText}!</h1>
